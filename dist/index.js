...
var axios = require('axios'); // const Vue = require('vue/dist/vue.runtime.common.prod')


window.onload = function () {
  axios.get('JSON.txt').then(function (resp) {
    new Vue({
      el: '#main-container',
      data: _objectSpread({}, resp.data, {
        pic: 'profile.jpg'
      }),
      components: {
      ...
      methods: {
        getPicAddress: function getPicAddress() {
          return this['Pic Address'];
        }
      },
      created: function created() {
        var sp = document.querySelector('.sp-cont');
        sp.style.opacity = 1;
